...
const Resumebuilder = ({ initialContent }) => {
  ...
  const getContactMarkdown = () => {
    ...
    const mobile = contactInfo.mobile?.trim();
    ...
    if (linkedin)
      parts.push(
        `<a href="${linkedin}" target="_blank" style="text-decoration:none;">LinkedIn</a>`
      );
    if (twitter)
      parts.push(
    ...
    return `
<p style="text-align:center; font-size:32px; font-weight:bold; margin-bottom:2px;">
${name}
</p>
...
${section("Professional Summary", bulletify(summary))}
${section("Skills", bulletify(skills))}
  ...
  const generatePDF = async () => {
    ...
    try {
      ...
      const blob = await pdf(
        <ResumePDF data={finalData} /> // <-- updated line
      ).toBlob();
